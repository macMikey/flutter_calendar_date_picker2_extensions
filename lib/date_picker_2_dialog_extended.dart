...
/// Display CalendarDatePicker with action buttons and onValueChanged parameter
Future<List<DateTime?>?> calendarDatePicker2DialogExtended({
            ...
            config: config.copyWith(
              ...
              scrollViewConstraints: config.scrollViewConstraints ??
                  (config.calendarViewMode == CalendarDatePicker2Mode.scroll
                      ? BoxConstraints(maxHeight: dialogHeight.toDouble() - 24 * 2)
                      : null),
            ),
